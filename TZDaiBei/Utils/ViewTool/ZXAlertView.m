...
- (void)successStatus {
    ...
    self.showView.width = iPW(250);
    self.showView.height = iPH(120);
    self.showView.center = CGPointMake(kScreenWidth/2, kScreenHeight/2);
    [self.showView.subviews makeObjectsPerformSelector:@selector(removeFromSuperview)];
    self.showView.backgroundColor = [UIColor whiteColor];

    
    UIImageView *icon = [[UIImageView alloc] initWithFrame:CGRectMake(0, iPH(19), iPW(45), iPH(45))];
    ...
    self.titleLab.top = icon.bottom + iPH(22);
...
- (void)showCenterTitle:(NSString *)title message:(NSString *)message {
    ...
    self.detailLab.top = self.titleLab.bottom + 4;
...
//    }
    ...
    self.showView.width = iPW(150);
    [self.titleLab autoSizeHorizontal];
    
    if (self.titleLab.width > iPW(270)) {
        self.titleLab.width = iPW(270);
        self.titleLab.numberOfLines = 0;
        [self.titleLab autoSizeVertical];
        self.showView.height = self.titleLab.height+40;
    }else{
        self.showView.height = iPH(60);
    }
...
//    self.titleLab.width = iPW(150) - 50;
